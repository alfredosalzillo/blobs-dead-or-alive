...
const mod1 = (async () => {
    ...
    var ne = O(g()), oe = O(g()), { createRef: fe, version: le, Children: pe, useState: ae, useReducer: ye, Suspense: de, createContext: _e, PureComponent: ve, forwardRef: me, useLayoutEffect: he, useMemo: Ee, StrictMode: Se, Component: Ce, useContext: Re, useDebugValue: ke, useImperativeHandle: $e, useRef: ge, Fragment: je, Profiler: Oe, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Pe, createElement: xe, memo: Ie, useEffect: we, cloneElement: Ae, createFactory: Fe, isValidElement: Le, lazy: qe, useCallback: De } = ne;
    var export_default = oe.default;
    return { Children: pe, Component: Ce, Fragment: je, Profiler: Oe, PureComponent: ve, StrictMode: Se, Suspense: de, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Pe, cloneElement: Ae, createContext: _e, createElement: xe, createFactory: Fe, createRef: fe, default: export_default, forwardRef: me, isValidElement: Le, lazy: qe, memo: Ie, useCallback: De, useContext: Re, useDebugValue: ke, useEffect: we, useImperativeHandle: $e, useLayoutEffect: he, useMemo: Ee, useReducer: ye, useRef: ge, useState: ae, version: le };
})();
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`);
    ...
    var Nf = Mi(zi()), Pf = Mi(zi()), { findDOMNode: Mf, render: Rf, unmountComponentAtNode: Df, unstable_renderSubtreeIntoContainer: If, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ff, createPortal: jf, flushSync: Uf, hydrate: Vf, unstable_batchedUpdates: Bf, unstable_createPortal: Wf, version: Hf } = Nf;
    var export_default = Pf.default;
    return { __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: Ff, createPortal: jf, default: export_default, findDOMNode: Mf, flushSync: Uf, hydrate: Vf, render: Rf, unmountComponentAtNode: Df, unstable_batchedUpdates: Bf, unstable_createPortal: Wf, unstable_renderSubtreeIntoContainer: If, version: Hf };
})();

/* https://esm.sh/react-dom@17.0.1?external=react */
const mod5 = (async () => {
                    ...
                    React.createElement("div", { className: "controls" },
                        React.createElement("div", null,
                            React.createElement("progress", { id: "time-progress", value: (time - elapsed) / time, max: 1, "data-animated": elapsed > 0 },
                                elapsed,
                                "ms"),
                            React.createElement("label", { for: "time-progress", className: "time-progress-label" },
